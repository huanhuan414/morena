  ...
  async getAvatarContents(userId: string, avatarId?: string) {
    ...
    const contentsWithAvatar = contents.map((content: any) => {
      ...
      return {
        ...
        rawPlatform: content.orderPlatform || content.order_platform || '',
