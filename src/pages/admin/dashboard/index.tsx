      ...
      <View className="dashboard-page">
        ...
        <View className="quick-actions-section">
          ...
          <View className="quick-actions-grid">
            <View className="quick-action-btn" onClick={() => Taro.navigateTo({ url: '/pages/admin/users/index' })}>
              <Users size={24} color="#3b82f6" />
              <Text className="quick-action-text">用户管理</Text>
            </View>
            <View className="quick-action-btn" onClick={() => Taro.navigateTo({ url: '/pages/admin/orders/index' })}>
              <ShoppingCart size={24} color="#f59e0b" />
              <Text className="quick-action-text">订单管理</Text>
            </View>
            <View className="quick-action-btn" onClick={() => Taro.navigateTo({ url: '/pages/admin/content/index' })}>
              <Eye size={24} color="#8b5cf6" />
              <Text className="quick-action-text">内容审核</Text>
            </View>
            <View className="quick-action-btn" onClick={() => Taro.navigateTo({ url: '/pages/admin/finance/index' })}>
